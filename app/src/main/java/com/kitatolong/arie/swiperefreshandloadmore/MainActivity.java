package com.kitatolong.arie.swiperefreshandloadmore;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvItem = (LoadMoreView)findViewById(R.id.lv_item);
        ...
        lvItem.setOnLoadMoreListener(new LoadMoreView.OnLoadMoreListener() {
            @Override
